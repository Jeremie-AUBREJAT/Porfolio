...
<body class="lg:h-screen  bg-gradient-to-r from-gray-900 to-gray-700">
    ...
    <div style="background-image: url('asset/img/background3.png');" class="rounded-2xl lg:m-32 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        ...
        <div class=" xl:rounded-2xl bg-gray-400 bg-opacity-95">
            ...
            <div class=" flex justify-center items-center h-2/3 lg:mx-20 mt-8 rounded-b-lg">
                <div class="bg-gray-200 p-4 rounded-lg shadow-2xl w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/3 text-center mb-8">
